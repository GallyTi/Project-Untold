...
#include "ProjectUntoldCharacter.h"
...
AProjectUntoldCharacter::AProjectUntoldCharacter()
{
...
void AProjectUntoldCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AProjectUntoldCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AProjectUntoldCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AProjectUntoldCharacter::Look);
	}
	else
	{
...
void AProjectUntoldCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
